  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 fill-mode-forwards p-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-white/60 mt-2 text-sm">Configure global application settings and broadcast announcements.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-white/50 mt-1">Lock down the platform for updates.</p>
              </div>
            ...
            <div className="pt-4 border-t border-white/10">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <label className="text-sm font-medium text-white">Global Banner</label>
                  <p className="text-xs text-white/50 mt-1">Show a banner at the top of all apps.</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all disabled:opacity-50"
            ...
            <button 
              ...
              disabled={loading}
              className="w-full flex items-center justify-center space-x-2 bg-white/10 hover:bg-white/20 text-white px-4 py-2.5 rounded-xl transition-all border border-white/5 mt-4"
            >
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 backdrop-blur-xl">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-xl font-semibold text-white">Global Announcement</h2>
          </div>
          ...
          <form onSubmit={handleSendAnnouncement} className="space-y-4">
            <div>
              ...
              <textarea 
                ...
                rows={4}
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all resize-none"
            ...
            <button 
              type="submit"
              className="w-full bg-purple-500 hover:bg-purple-600 text-white px-4 py-2.5 rounded-xl font-medium transition-all shadow-lg shadow-purple-500/25"
            >
              Broadcast Message
            </button>
          </form>
