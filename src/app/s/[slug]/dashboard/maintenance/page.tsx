  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Society maintenance dues, utility payments, and facility repair tasks.
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center space-y-3 shadow-xs">
        ...
        <h3 className="text-base font-bold text-slate-900">Maintenance & Dues Shell</h3>
        <p className="text-xs text-slate-500 max-w-sm mx-auto">
          This section is ready for flat maintenance billing statements, payment gateway history, and asset maintenance logs.
        </p>
      </div>
    </div>
  );
